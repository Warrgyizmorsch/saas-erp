                ...
                <div class="card stretch stretch-full">
                    <div class="card-body">
                        ...
                        <div class="text-start">
                            <a><span class="badge  bg-soft-success text-success">Issued : {{$completed_issued}}</span></a>
                            <a><span class="badge  bg-soft-warning text-warning">Partially Issued : {{$partially_issue}}</span></a>
                        </div>
                        <div class="pt-4">
                            <div class="d-flex align-items-center justify-content-between">
                                <a href="javascript:void(0);"
