                ...
                <form method="GET" action="{{ route('lead.leadActivity') }}" class="row g-3 mb-4" id="lead-filter-form">
                    ...
                    <div class="col-12 mb-3">
                        <div class="d-flex flex-wrap gap-2">
                            <button type="button" class="btn btn-outline-secondary btn-sm preset-btn2" data-preset="today">Today</button>
                            <button type="button" class="btn btn-outline-secondary btn-sm preset-btn2" data-preset="yesterday">Yesterday</button>
                            <button type="button" class="btn btn-outline-secondary btn-sm preset-btn2" data-preset="7days">Last 7 Days</button>
                            <button type="button" class="btn btn-outline-secondary btn-sm preset-btn2" data-preset="30days">Last 30 Days</button>
                            <button type="button" class="btn btn-outline-secondary btn-sm preset-btn2" data-preset="this-month">This Month</button>
                            <button type="button" class="btn btn-outline-secondary btn-sm preset-btn2" data-preset="last-month">Last Month</button>
                            <button type="button" class="btn btn-outline-secondary btn-sm preset-btn2" data-preset="custom">Custom</button>
                        </div>
                    </div>
                    ...
                    <div class="col-md-3">
                        ...
                        <input type="date" name="from" id="from-date2"
                    ...
                    <div class="col-md-3">
                        ...
                        <input type="date" name="to" id="to-date2"
                    ...
                    <div class="col-md-3">
                        ...
                        <select name="owner_id" class="form-control">
                            ...
                            <option value="null"
                                {{ request('owner_id') == 'null' ? 'selected' : '' }}>
                                Unknown
                            </option>
                            ...
                            <div class="card-body">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6 border-end">
                                        ...
                                        {{-- Followup Type --}}
                                        @if($cb->followup_type)
                                        <div><i class="fas fa-tag text-primary me-1"></i> <strong>Followup Type:</strong> {{ $cb->followup_type }}</div>
                                        @endif

                                        {{-- Followup Status --}}
                                        @if($cb->followup_status)
                                        <div><i class="fas fa-chart-line text-info me-1"></i> <strong>Followup Status:</strong> {{ $cb->followup_status }}</div>
                                        @endif
                                        ...
                                        <div> <i class="fas fa-signal text-danger me-1"></i> <strong>Engagement:</strong> {{ $cb->lead_engagement_status }}</div>
                                        @endif

                                        {{-- Bucket --}}
                                        @if($cb->bucket)
                                        <div><i class="fas fa-folder-open text-secondary me-1"></i> <strong>Bucket:</strong> {{ $cb->bucket }}</div>
                                        @endif

                                        {{-- Sub Status --}}
                                        @if($cb->status)
                                        <div><i class="fas fa-bookmark text-dark me-1"></i> <strong>Sub Status:</strong> {{ $cb->status }}</div>
                                        @endif
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        <div class="d-flex align-items-center gap-2 justify-content-start">
                                            <div class="avatar-image">
                                                ...
                                                <img src="{{ asset('storage/' . $cb->lead->owner->image) }}"
                                                    alt=""
