...
use Modules\HRMS\App\Models\Project;
use Modules\HRMS\App\Models\DailyTask;
use Modules\HRMS\App\Models\TaskFollowUp;
...
class ProjectController extends Controller
{
    public function index()
    {
        ...
        if ($isAdmin) {
            ...
            $employees = \Modules\HRMS\App\Models\Employee::where('id', $user->employee_id)->get();
        }

        $departments = \Modules\HRMS\App\Models\Department::all();
        return view('hrms::projects.index', compact('projects', 'employees', 'departments', 'isAdmin'));
    }
    ...
    public function create()
    {
        ...
        $departments = \Modules\HRMS\App\Models\Department::all();
        return view('hrms::projects.create', compact('employees', 'departments'));
    }
    ...
    public function show(Project $project)
    {
        ...
        return view('hrms::projects.show', compact('project', 'employees', 'departments', 'dayGroups'));
    }
    ...
    public function edit(Project $project)
    {
        ...
        return view('hrms::projects.edit', compact('project', 'employees', 'departments'));
    }
