            ...
            <div class="page-header-right ms-auto">
                <div class="page-header-right-items">
                    ...
                    <div class="d-flex align-items-center gap-2 page-header-right-items-wrapper">
                        ...
                        <a href="{{ route('send.whatsapp.all') }}" class="btn btn-success">
            ...
            @forelse($displayData as $userId => $row)
                ...
                <div class="report-section">
                    <div class="d-flex align-items-center gap-3 mb-3">
                        ...
                        <div class="d-flex align-items-center gap-3 flex-wrap">
                            ...
                            <span id="totalLeadCount{{ $userId }}"
                                class="d-inline-flex align-items-center gap-2 px-3 py-2 bg-light border" style="
                border-radius:10px;
                border-color:#dbe4ff !important;
                      ">
                            ...
                            <!-- TODAY / PAST TOGGLE -->
                            <div class="btn-group lead-toggle-group" role="group" data-user="{{ $userId }}" style="
                                         background:#eef2ff;
                                         padding:5px;
                                         border-radius:50px;
                                     ">

                                <button type="button" class="btn btn-primary lead-date-btn active" data-range="today"
                                    data-user="{{ $userId }}" style="
                                           border-radius:50px;
                                           padding:8px 18px;
                                           font-weight:600;
                                           border:none;
                                ...
                                <button type="button" class="btn btn-outline-primary lead-date-btn" data-range="previous"
                                    data-user="{{ $userId }}" style="
                                        border-radius:50px;
                                        padding:8px 18px;
                                        font-weight:600;
                                ...
                                <button type="button" class="btn btn-outline-primary lead-date-btn" data-range="past"
                                    data-user="{{ $userId }}" style="
                                        border-radius:50px;
                                        padding:8px 18px;
                                        font-weight:600;
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex flex-column gap-2">
                                            ...
                                            <div
                                                ...
                                                <span class="badge bg-danger cursor-pointer hot-count-btn"
                                                    id="hotCount{{ $userId }}" data-user="{{ $userId }}" style="
                                                        cursor:pointer;
                                                        padding:7px 12px;
                                                        border-radius:8px;
                                                        transition:.2s;
                                            ...
                                            <div
                                                ...
                                                <span class="badge bg-primary cursor-pointer hot-count-btn"
                                                    id="duplicateHotCount{{ $userId }}" data-user="{{ $userId }}"
                                                    data-type="duplicate_hot" style="
                                                        cursor:pointer;
                                                        padding:7px 12px;
                                                        border-radius:8px;
                                                        transition:.2s;
                                    ...
                                    <td class="text-center">
                                        ...
                                        <div class="status-box cursor-pointer lead-filter-btn " data-user="{{ $userId }}"
                                            data-type="15">

                                            <div class="stat-value text-info" id="count15_{{ $userId }}"
                                    ...
                                    <td class="text-center">
                                        ...
                                        <div class="status-box cursor-pointer lead-filter-btn" data-user="{{ $userId }}"
                                            ...
                                            <div class="stat-value text-warning" id="count23_{{ $userId }}"
                                                style="font-size: 28px;">
                                    ...
                                    <td class="text-center">
                                        ...
                                        <div class="status-box cursor-pointer lead-filter-btn" data-user="{{ $userId }}"
                                            ...
                                            <div class="stat-value text-primary" id="count30_{{ $userId }}"
                                                style="font-size: 28px;">
                                    ...
                                    <td class="text-center">
                                        ...
                                        <div class="status-box cursor-pointer lead-filter-btn" data-user="{{ $userId }}"
                                            ...
                                            <div class="stat-value text-success" id="count48_{{ $userId }}"
                                                style="font-size: 28px;">
                                    ...
                                    <td class="text-center">
                                        ...
                                        <div class="status-box cursor-pointer lead-filter-btn" data-user="{{ $userId }}"
                                            ...
                                            <div class="stat-value text-success" id="count8_{{ $userId }}"
                                                style="font-size: 28px;">
