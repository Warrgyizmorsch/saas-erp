                                                                    ...
                                                                    <tr class="cons-row" data-unit="{{ $unit }}">
                                                                        ...
                                                                        <td>
                                                                            ...
                                                                            <div class="small text-muted">
                                                                                Issued: <span class="fw-semibold text-dark"> {{ $itemh }} X {{ $itemW }}</span>
                                                                                &nbsp;|&nbsp;
                                                                        ...
                                                                        <td>
                                                                            <div class="d-flex gap-2">
                                                                                <div class="flex-grow-1">
                                                                                    ...
                                                                                    <select name="items[{{ $p->id }}][machine_id]" class="form-control form-control-sm" {{ $isLocked ? 'disabled' : '' }}>
                                                                                ...
                                                                                <div class="flex-grow-1">
                                                                                    ...
                                                                                    <select name="items[{{ $p->id }}][project_id]" class="form-control form-control-sm" {{ $isLocked ? 'disabled' : '' }}>
                                                                                        <option value="">Select</option>
                                                                                        @foreach($projects as $project)
