                        ...
                        <div class="d-flex justify-content-between align-items-start mb-4">
                            ...
                            <div class="text-end">
                                ...
                                <div class="d-inline-flex align-items-center gap-2 mt-1">
                                    <span class="fs-13 fw-semibold text-muted">
                                        History
                                    </span>
                            ...
                            <table class="table table-hover align-middle border">
                                ...
                                <tbody class="bg-white">
                                    ...
                                    <tr class="{{ $isDuplicate ? 'border-top-0' : '' }}">
                                        ...
                                        <td>
                                            @if(!$isDuplicate)
                                            <div class="fw-semibold text-dark">{{ $row->machine?->name ?? 'N/A' }}</div>
                                            <div class="fs-11 text-muted">ID: {{ $row->machine_id }}</div>
                                            @else
                                            {{-- Khali chor denge cloned rows ke liye --}}
    ...
    <div class="offcanvas offcanvas-end"
        ...
        <div class="offcanvas-header ht-80 px-4 border-bottom border-gray-5">
            <h2 class="fs-16 fw-bold mb-0">
                Requisition Slip History
            </h2>
            <button type="button"
                class="btn-close btn-close-gray ms-auto"
                    ...
                    <div class="row g-3">
                        <div class="col-6">
                            ...
                            <div class="fw-semibold">
                                #RS-{{ str_pad($rs->rs_id, 3, '0', STR_PAD_LEFT) }}
                            </div>
                        </div>
