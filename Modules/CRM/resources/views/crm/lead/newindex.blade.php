...
@section('content')
    ...
    <div class="container-fluid">
        ...
        <x-crm::lead.tools :buckets="$mainbuckets" :filterBucket="$filterBucket" :totalLeadsCount="$totalLeadsCount"
        ...
        <div class="d-flex flex-wrap  align-items-center justify-content-between gap-3 mb-3 px-3 ">
            ...
            <div class="d-flex flex-wrap gap-3">
                ...
                <a href="javascript:void(0);" class="bulk-owner text-warning">
            ...
            <div class="col-12">
                @forelse($leads as $lead)
                    <div class="card shadow-sm mb-3 border-0">
                            ...
                            <div class="d-flex justify-content-center align-items-center mx-3" title="Status Progress">
                                @php
                                    ...
                                    if ($bucket && $bucket->parent_id) {
                                        $bucket = \Modules\CRM\App\Models\Bucket::find($bucket->parent_id);
                                    }
                                ...
                                @if($message || $followup)
                                    ...
                                    @if($message)
                                        <p class="fs-12 text-dark mb-1 mt-1">
                                            ...
                                            @if($isLong)
                                                <a href="javascript:void(0);" class="open-callback text-warning" data-bs-toggle="offcanvas"
                            ...
                            <div>
                                <div class="d-flex flex-wrap align-items-center  ms-auto text-warning fs-5">
                                    ...
                                    <div class="text-muted fs-14 me-2" title="Messages">
                                        <i class="far fa-comment-alt text-warning "></i>
                                        {{ $lead->messages ? $lead->messages->count() : 0 }}
                                    </div>
                                    <a href="tel:{{ optional($lead->user)->contact_no }}" class="text-warning me-2"><i
                                            class="fas fa-phone-alt"></i></a>
                                    <a href="javascript:void(0);" class="open-callback text-warning me-2"
                                        data-bs-toggle="offcanvas" data-bs-target="#proposalSent{{ $lead->id }}"><i
                                            class="fas fa-comment-dots"></i></a>
                                    <a href="javascript:void(0);" class="open-whatsapp text-warning me-2"
                                        data-bs-toggle="offcanvas" data-bs-target="#whatsappSent{{ $lead->id }}"><i
                                            class="fab fa-whatsapp fs-5"></i></a>
                                    <a href="javascript:void(0);" class="open-SMS text-warning me-2" data-bs-toggle="offcanvas"
                                        data-bs-target="#SMSSent{{ $lead->id }}"><i class="fa-solid fa-message"></i></a>

                                    <a href="javascript:void(0);" class="text-warning me-2" data-bs-toggle="modal"
                        ...
                        <div class="offcanvas offcanvas-end" tabindex="-1" id="editStatusOffcanvas-{{ $lead->id }}"
                            aria-labelledby="editStatusOffcanvasLabel-{{ $lead->id }}" style="width: 400px;">
                            <div class="offcanvas-header border-bottom bg-light py-3">
                                <h6 class="offcanvas-title d-flex align-items-center gap-2 fw-bold text-dark"
                                    id="editStatusOffcanvasLabel-{{ $lead->id }}">
                                    <i class="fa-solid fa-clipboard-list text-secondary"></i>
                                    Edit Followup for <span
                                        class="text-capitalize">{{ optional($lead->user)->name ?? 'User' }}</span>
                                </h6>
                            ...
                            <div class="offcanvas-body p-4 bg-white">
                                <form id="quickUpdateForm-{{ $lead->id }}" action="{{ route('lead.updateQuick', $lead->id) }}"
                                    ...
                                    <div class="mb-4">
                                        <label class="form-label text-muted small mb-1" style="font-size: 12px;">Engagement
                                            Status </label>
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <select name="lead_bucket_id"
                                            class="form-select bg-light border-0 shadow-sm bucket-select required-field"
                                            style="font-size: 14px;">
                                    ...
                                    <div class="mb-4">
                                        <label class="form-label text-muted small mb-1" style="font-size: 12px;">Next Follow-up
                                            Date</label>
                                        <input type="datetime-local" class="form-control bg-light border-0 shadow-sm"
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <textarea class="form-control bg-light border-0 shadow-sm" name="message" rows="3"
                                            placeholder="Write a comment..." style="font-size: 14px; resize: none;"></textarea>
                                    </div>
                                    <div class="mb-4">
                                        <label class="form-label text-muted small mb-1" style="font-size: 12px;">
                                            Upload Call Recording
                                        </label>
                                        <input type="file" name="call_recording"
                                    ...
                                    <div class="d-flex justify-content-end gap-3 pt-3 mt-4 border-top">
                                        <button type="button" class="btn btn-white text-secondary fw-bold border px-4"
                                            data-bs-dismiss="offcanvas" style="font-size: 13px;">CLOSE</button>
                                        <button type="submit" class="btn text-white fw-bold px-4"
                                            style="background-color: #f47b20; font-size: 13px; border-radius: 4px;">UPDATE
                                            DETAILS</button>
                                    </div>
                                </form>
                            </div>
                                    ...
                                    <form action="{{ route('lead.storeTodo', $lead->id) }}" method="POST">
                                        ...
                                        <div class="text-end mt-2">
                                            <button type="submit" class="btn text-white fw-bold px-4 py-2"
                                                style="background-color: #3b5bdb; font-size: 13px;">SAVE TO-DO</button>
                                        </div>
                                    </form>
                                </div>
                                        ...
                                        <div class="card mb-3 shadow-none" style="border: 1px dashed #cbd5e1; border-radius: 8px;">
                                            <div class="card-body p-3 d-flex align-items-center">
                                                ...
                                                <div class="rounded text-center p-2 me-3 d-flex flex-column justify-content-center"
                                                    style="background-color: #fef0db; color: #f47b20; min-width: 55px; height: 55px;">
                                                    <span class="fw-bold"
                                                ...
                                                <div class="flex-grow-1">
                                                    <div class="d-flex align-items-center mb-1 gap-2">
                                                        ...
                                                        <span class="badge"
                                                            style="background-color: #fef0db; color: #f47b20; font-size: 10px;">{{ $task->status }}</span>
                                                    </div>
                        ...
                        <div class="collapse w-100" id="details-{{ $lead->id }}">
                            <div class="border-top p-4 bg-white"
                                style="border-left: 4px solid #f47b20; border-bottom-left-radius: 0.375rem; border-bottom-right-radius: 0.375rem;">
                ...
                <form id="leadForm" method="POST" action="{{ route('lead.store') }}">
                    ...
                    <div class="modal-footer bg-light mx-n4 mb-n4 px-4 py-3 mt-4 border-top">
                        ...
                        <button type="submit" id="btnSubmit" class="btn text-white px-4 fw-medium"
                            style="background-color: #f47b20;">Create Lead</button>
                    </div>
                </form>
            </div>
        </div>
