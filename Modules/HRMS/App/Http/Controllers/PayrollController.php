...
class PayrollController extends Controller
{
    ...
    public function attendance(Request $request)
    {
        ...
        return view('hrms::payroll.attendance', compact('attendance', 'employees'));
    }
    ...
    public function getAttendance(Request $request)
    {
        ...
        return view('hrms::payroll.attendance', compact('attendance'));
    }
    ...
    public function addAttendance()
    {
        ...
        return view('hrms::payroll.add-attendance', compact('employees'));
    }
    ...
    {
        return view('hrms::payroll.calculation');
    }
    ...
    public function index(Request $request)
    {
        ...
        return view('hrms::payroll.index', compact('payrolls'));
    }
    ...
    public function show($id)
    {
        ...
        return view('hrms::payroll.show', compact('payroll'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('hrms::payroll.add-attendance', [
    ...
    public function editByName(Request $request, $employee_id)
    {
        ...
        return view('hrms::payroll.edit-attendance-by-name', compact('employee', 'attendance'));
    }
